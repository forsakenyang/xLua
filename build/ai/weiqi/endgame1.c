...
static struct patval_a endpat0[] = {
  {684,2},	{721,2},	{758,3},	{759,3}
};

static struct patval_a endpat1[] = {
  {684,2},	{721,2},	{758,3},	{759,3}
};

static struct patval_a endpat2[] = {
  {796,1},	{721,1},	{758,1},	{684,2},
  {759,2},	{722,2},	{685,3},	{795,3},
  {797,3},	{723,0},	{760,0},	{686,0}
};

static struct patval_a endpat3[] = {
  {796,1},	{721,1},	{758,1},	{684,2},
  {759,2},	{722,2},	{797,3},	{795,3},
  {686,0},	{723,0},	{760,0}
};

static struct patval_a endpat4[] = {
  {758,1},	{721,1},	{684,2},	{759,2},
  {722,2},	{686,0},	{723,0},	{760,0}
};

static struct patval_a endpat5[] = {
  {684,1},	{722,1},	{758,2},	{721,2},
  {795,0},	{759,0},	{796,0}
};

static struct patval_a endpat6[] = {
  {684,1},	{721,2}
};

static struct patval_a endpat7[] = {
  {832,1},	{795,1},	{721,2},	{758,2},
  {684,2},	{759,0},	{796,0},	{833,0}
};

static struct patval_a endpat8[] = {
  {684,1},	{611,2}
};

static struct patval_a endpat9[] = {
  {795,1},	{758,1},	{721,2},	{684,2},
  {759,0},	{796,0}
};

static struct patval_a endpat10[] = {
  {684,1},	{648,1},	{611,1},	{574,2},
  {575,0},	{612,0},	{649,0},	{686,0}
};

static struct patval_a endpat11[] = {
  {721,1},	{684,2},	{759,0}
};

static struct patval_a endpat12[] = {
  {721,1},	{684,2},	{759,0}
};

static struct patval_a endpat13[] = {
  {721,1},	{684,2},	{758,0},	{795,0},
  {759,0},	{796,0}
};

static struct patval_a endpat14[] = {
  {721,1},	{684,2},	{610,0},	{611,0},
  {759,0}
};

static struct patval_a endpat15[] = {
  {685,1},	{648,2},	{684,2}
};

static struct patval_a endpat16[] = {
  {721,1},	{684,2},	{648,2},	{759,0}
};

static struct patval_a endpat17[] = {
  {721,1},	{684,2}
};

static struct patval_a endpat18[] = {
  {721,1},	{684,2},	{795,2},	{758,0},
  {759,0},	{796,0}
};

static struct patval_a endpat19[] = {
  {684,1},	{721,1},	{648,2}
};

static struct patval_a endpat20[] = {
  {758,1},	{721,1},	{684,2},	{722,2},
  {795,0},	{759,0},	{796,0}
};

static struct patval_a endpat21[] = {
  {758,1},	{721,1},	{684,2},	{722,2},
  {795,0},	{759,0},	{796,0}
};

static struct patval_a endpat22[] = {
  {684,1},	{648,2}
};

static struct patval_a endpat23[] = {
  {684,1},	{758,1},	{685,2},	{759,0}
};

static struct patval_a endpat24[] = {
  {684,1},	{685,2}
};

static struct patval_a endpat25[] = {
  {685,1},	{684,2}
};

static struct patval_a endpat26[] = {
  {685,1},	{684,2}
};

static struct patval_a endpat27[] = {
  {721,1},	{684,2},	{758,2},	{759,0}
};

static struct patval_a endpat28[] = {
  {722,1},	{684,2},	{685,2},	{723,3},
  {649,0},	{686,0}
};

static struct patval_a endpat29[] = {
  {648,1},	{684,1},	{685,2},	{721,2},
  {647,3},	{610,3},	{611,0},	{612,0},
  {649,0},	{686,0},	{723,0}
};

static struct patval_a endpat30[] = {
  {721,1},	{684,2}
};

static struct patval_a endpat31[] = {
  {721,1},	{684,2},	{759,0}
};

static struct patval_a endpat32[] = {
  {685,1},	{721,1},	{684,2},	{648,2},
  {649,0},	{686,0},	{723,0}
};

static struct patval_a endpat33[] = {
  {684,1},	{721,2},	{759,0}
};

static struct patval_a endpat34[] = {
  {684,1},	{721,2}
};

static struct patval_a endpat35[] = {
  {759,1},	{721,1},	{684,2},	{722,2}
};

static struct patval_a endpat36[] = {
  {684,1},	{721,2},	{685,2},	{759,2}
};

static struct patval_a endpat37[] = {
  {759,1},	{721,1},	{685,1},	{684,2}
};

static struct patval_a endpat38[] = {
  {684,1},	{722,1},	{759,2},	{721,2}
};

static struct patval_a endpat39[] = {
  {648,1},	{686,1},	{685,2},	{684,2},
  {649,0}
};

static struct patval_a endpat40[] = {
  {685,1},	{684,1},	{648,2},	{686,2},
  {649,0}
};

static struct patval_a endpat41[] = {
  {685,1},	{684,1},	{648,2},	{686,2},
  {722,2},	{649,0},	{723,0}
};

static struct patval_a endpat42[] = {
  {722,1},	{684,1},	{723,1},	{724,2},
  {686,2},	{685,2},	{647,3},	{649,0},
  {650,0},	{687,0}
};

static struct patval_a endpat43[] = {
  {722,1},	{723,1},	{685,1},	{648,2},
  {686,2},	{684,2},	{649,0}
};

static struct patval_a endpat44[] = {
  {759,1},	{721,2},	{684,2}
};

static struct patval_a endpat45[] = {
  {759,1},	{721,1},	{684,2},	{648,2},
  {722,2}
};

static struct patval_a endpat46[] = {
  {685,1},	{721,1},	{759,1},	{684,2},
  {648,2}
};

static struct patval_a endpat47[] = {
  {684,2},	{609,0},	{610,0}
};

static struct patval_a endpat48[] = {
  {722,1},	{648,1},	{684,2},	{611,0},
  {612,0},	{649,0},	{686,0},	{723,0}
};

static struct patval_a endpat49[] = {
  {722,1},	{684,2},	{723,3},	{649,0},
  {686,0}
};

static struct patval_a endpat50[] = {
  {684,1},	{686,2},	{649,0}
};

static struct patval_a endpat51[] = {
  {684,1},	{795,2},	{757,3},	{720,3},
  {758,0},	{759,0},	{796,0}
};

static struct patval_a endpat52[] = {
  {758,1},	{759,1},	{684,2}
};

static struct patval_a endpat53[] = {
  {684,1},	{721,1},	{722,2},	{685,2},
  {758,0},	{759,0},	{686,0},	{723,0},
  {760,0}
};

static struct patval_a endpat54[] = {
  {722,1},	{684,2},	{685,2},	{721,3},
  {758,0},	{759,0},	{686,0},	{723,0},
  {760,0}
};

static struct patval_a endpat55[] = {
  {758,1},	{684,1},	{759,2},	{685,2}
};

static struct patval_a endpat56[] = {
  {685,1},	{759,1},	{684,2},	{758,2}
};

static struct patval_a endpat57[] = {
  {684,1},	{612,1},	{721,2},	{685,2},
  {648,2},	{759,0},	{649,0},	{686,0},
  {723,0},	{760,0}
};

static struct patval_a endpat58[] = {
  {684,1},	{648,1},	{649,2},	{722,2},
  {612,2},	{686,0},	{723,0},	{613,0},
  {650,0},	{687,0},	{724,0}
};

static struct patval_a endpat59[] = {
  {722,1},	{723,1},	{758,1},	{684,2},
  {797,4},	{796,4},	{759,0},	{760,0}
};

static struct patval_a endpat60[] = {
  {685,1},	{684,2},	{758,0},	{759,0}
};

static struct patval_a endpat61[] = {
  {684,2},	{722,2}
};

static struct patval_a endpat62[] = {
  {723,1},	{721,1},	{759,1},	{684,2},
  {722,2},	{648,2},	{686,2}
};

static struct patval_a endpat63[] = {
  {685,1},	{721,1},	{759,1},	{723,1},
  {684,2},	{648,2},	{686,2}
};

static struct patval_a endpat64[] = {
  {758,1},	{684,2},	{757,0},	{759,0}
};

static struct patval_a endpat65[] = {
  {684,1},	{611,2},	{686,2},	{649,0}
};

static struct patval_a endpat66[] = {
  {684,1},	{611,2},	{686,2},	{612,3},
  {649,0}
};

static struct patval_a endpat67[] = {
  {684,1},	{722,2}
};

static struct patval_a endpat68[] = {
  {684,1},	{685,2}
};

static struct patval_a endpat69[] = {
  {684,1},	{758,2}
};

static struct patval_a endpat70[] = {
  {684,1},	{758,1},	{760,2},	{686,2},
  {759,0},	{723,0}
};

static struct patval_a endpat71[] = {
  {684,1},	{758,1},	{760,2},	{686,2},
  {759,0},	{723,0}
};

static struct patval_a endpat72[] = {
  {649,1},	{684,1},	{723,2},	{686,0}
};

static struct patval_a endpat73[] = {
  {684,1},	{721,1},	{686,1},	{760,2},
  {759,0},	{723,0}
};

static struct patval_a endpat74[] = {
  {649,1},	{684,1},	{722,2}
};

static struct patval_a endpat75[] = {
  {722,1},	{684,2},	{649,2}
};

static struct patval_a endpat76[] = {
  {684,1},	{723,1},	{721,2},	{686,3}
};

static struct patval_a endpat77[] = {
  {721,1},	{684,2},	{723,2},	{686,4}
};

static struct patval_a endpat78[] = {
  {758,1},	{684,1},	{759,2},	{685,2}
};

static struct patval_a endpat79[] = {
  {722,1},	{684,2},	{758,2}
};

static struct patval_a endpat80[] = {
  {722,1},	{758,2},	{684,2},	{757,3}
};

static struct patval_a endpat81[] = {
  {722,1},	{758,2},	{684,2},	{757,3},
  {683,3}
};

static struct patval_a endpat82[] = {
  {721,1},	{684,2},	{648,2},	{722,2}
};

static struct patval_a endpat83[] = {
  {684,1},	{723,2},	{649,2},	{650,4},
  {724,4},	{687,4},	{686,0}
};

static struct patval_a endpat84[] = {
  {722,1},	{724,1},	{760,1},	{684,2},
  {761,2},	{687,3},	{759,3},	{723,0},
  {686,0}
};

static struct patval_a endpat85[] = {
  {611,1},	{721,1},	{684,2},	{649,2},
  {722,2},	{686,0},	{723,0}
};

static struct patval_a endpat86[] = {
  {722,1},	{685,1},	{758,1},	{684,2},
  {759,0}
};

static struct patval_a endpat87[] = {
  {685,1},	{759,1},	{758,2},	{684,2}
};

static struct patval_a endpat88[] = {
  {758,1},	{684,1},	{722,2},	{757,0}
};

static struct patval_a endpat89[] = {
  {721,1},	{684,2},	{686,2},	{723,0}
};

static struct patval_a endpat90[] = {
  {721,1},	{684,2},	{686,2},	{723,0}
};

static struct patval_a endpat91[] = {
  {684,1},	{759,1},	{758,1},	{685,2}
};

static struct patval_a endpat92[] = {
  {684,1},	{758,1},	{723,2}
};

static struct patval_a endpat93[] = {
  {684,1},	{758,1},	{723,2},	{685,2},
  {759,4}
};

static struct patval_a endpat94[] = {
  {723,1},	{684,2},	{758,2},	{685,2},
  {721,2},	{759,2}
};

static struct patval_a endpat95[] = {
  {684,2},	{795,2},	{758,0}
};

static struct patval_a endpat96[] = {
  {684,1},	{722,1},	{758,2}
};

static struct patval_a endpat97[] = {
  {611,1},	{649,1},	{684,2},	{612,0}
};

static struct patval_a endpat98[] = {
  {758,1},	{722,2},	{684,2}
};

static struct patval_a endpat99[] = {
  {684,1},	{611,2},	{649,2},	{612,0}
};

static struct patval_a endpat100[] = {
  {684,1},	{611,2},	{649,2},	{612,0}
};

static struct pattern_b endpat[102];
...
static struct pattern_b endpat[] = {
